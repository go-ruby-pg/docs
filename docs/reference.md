...
The public API lives at the module root (`github.com/go-ruby-pg/pg`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `pg`, while the surface follows
...
```go
import "github.com/go-ruby-pg/pg"
```
...
- **[pkg.go.dev/github.com/go-ruby-pg/pg](https://pkg.go.dev/github.com/go-ruby-pg/pg)**

The module's [README](https://github.com/go-ruby-pg/pg#readme) carries worked
