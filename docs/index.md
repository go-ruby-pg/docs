# go-ruby-pg documentation

**Pure-Go (CGO=0) MRI-faithful Ruby pg**

`go-ruby-pg/pg` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `pg`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-pg/pg`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `pg`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-pg/pg
```
...
| Repo | What it is |
| --- | --- |
| [`pg`](https://github.com/go-ruby-pg/pg) | the library — Ruby's `pg` in pure Go |
| [`docs`](https://github.com/go-ruby-pg/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-pg.github.io`](https://github.com/go-ruby-pg/go-ruby-pg.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-pg/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-pg/pg](https://github.com/go-ruby-pg/pg).
